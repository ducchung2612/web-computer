...
function addHeader() {
	...
	<div class="header group">
        <div class="logo">
            <a href="index.html">
                <img src="img/computer5.png" alt="Trang chủ computer Store" title="Trang chủ computer Store">
            </a>
        </div> <!-- End Logo -->
...
function addFooter() {
    ...
    <div class="copy-right">
        <p><a href="index.html">Computer Store</a> - All rights reserved © 2025 - Designed by
