...
window.onload = function () {
    ...
    var tags = ["Lenovo", "Asus", "Acer", "Mac", "Dell"]
...
function addDonHang(dh) {
    ...
    var paymentClass = '';
    var paymentIcon = '';
    if (dh.thongTinGiaoHang && dh.thongTinGiaoHang.paymentMethod) {
        var pm = dh.thongTinGiaoHang.paymentMethod;
        if (pm === 'cod') {
    ...
    var s = `
            <table class="listSanPham">
                <tr> 
                    <th colspan="7" class="donhang-ngay">
    ...
    for (var i = 0; i < dh.sp.length; i++) {
        ...
        s += `
                <tr>
                    ...
                    <td style="text-align: center" class="` + paymentClass + `">` + paymentIcon + paymentText + `</td>
                </tr>
            `;
    ...
    s += `
                <tr class="tong-tien-row" style="font-weight:bold; text-align:center; height: 4em;">
                    <td colspan="7">
                        <span style="float:left;">TỔNG TIỀN: </span>
                        <span style="float:right;">` + numToString(totalPrice) + ` ₫  |  ` + dh.tinhTrang + `</span>
                    </td>
                </tr>
            </table>
            <hr>
