window.onload = function () {
	...
	// Thêm danh sách hãng máy tính
	var company = ["Lenovo.jpg", "Asus.jpg", "acer.jpg", "gigabyte.png", "Mac.png", "dell.jpg",
		"MSI.jpg", "HP.jpg" 
	];
	...
	// Thêm chọn mức giá
	addPricesRange(20000000, 40000000);
	addPricesRange(40000000, 50000000);
	addPricesRange(50000000, 60000000);
	addPricesRange(60000000, 0);
